const local: App.I18n.Schema = {
	system: {
		title: 'SoybeanAdmin',
		subTitle: 'SoybeanAdminsSubTitle',
	...
	route: {
		...
		exception_500: '500',
		analysis: '隐写分析',
		analysis_one: '单张图像隐写分析',
		analysis_two: '批量图像隐写分析',
		analysis_three: '历史记录查询',
		'dataset-manage': '数据集管理',
		'module-manage': '模型管理',
		'module-manage_module-config': '训练参数设置',
		'module-manage_module-record': '模型信息管理',
		'model-training': '模型训练',
		'model-training_training-log': '查看训练日志',
		'model-training_weight-file': '权重文件管理',
	},
	page: {
		login: {
			common: {
